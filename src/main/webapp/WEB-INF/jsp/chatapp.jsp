...
<script
	src='https://production-assets.codepen.io/assets/editor/live/console_runner-079c09a0e3b9ff743e39ee2d5637b9216b3545af0de366d4b9aad9dc87e26bfd.js'></script>
<!-- <script src='//production-assets.codepen.io/assets/editor/live/events_runner-73716630c22bbc8cff4bd0f07b135f00a0bdc5d14629260c3ec49e5606f98fdd.js'></script> -->
<script
	src='https://production-assets.codepen.io/assets/editor/live/css_live_reload_init-2c0dc5167d60a5af3ee189d570b1835129687ea2a61bee3513dee3a50c115a77.js'></script>
<meta charset='UTF-8'>
	...
	<div id="frame">
			...
			<div id="profile">
				<div class="wrap">
					...
					<div id="expanded">
						...
						<label for="myProfile"></label>
						<button name="myProfile" class="btn btn-dark btn-sm btn-block"
							id="btnMyProfile" data-toggle="modal" data-target="#modal">
							<i class="fa fa-user fa-fw" aria-hidden="true"></i>My Profile
						</button>
						<br> <label for="logout"></label>
						<button name="logout" class="btn btn-dark btn-sm btn-block"
							id="btnLogout">
		...
		<div class="content">
			<div class="contact-profile">
				<div id="divContactProfile" data-toggle="modal" data-target="#modal">
					<img src="http://emilcarlsson.se/assets/harveyspecter.png" alt="" />
					<p>Harvey Specter</p>
				</div>
				<div>
					<div class="social-media">
						<button class="btn btn-sm default" id="toggle">Select</button>
						<button class="btn btn-sm default" id="toggleDone"
							data-toggle="modal" data-target="#modal">Done</button>
					</div>
				</div>
			</div>
			...
			<div class="messages">
				...
				<ul>
					...
					<input type="checkbox" class="chk"
						value="How the hell am I supposed to get a jury to believe you when I am not even sure that I do?!">
					<li class="replies"><img
						src="http://emilcarlsson.se/assets/harveyspecter.png" alt="" />
						<p>When you're backed against the wall, break the god damn
							thing down.</p></li>
					<input type="checkbox" class="chk"
						value="When you're backed against the wall, break the god damn thing down">
					<li class="replies"><img
						src="http://emilcarlsson.se/assets/harveyspecter.png" alt="" />
						<p>Excuses don't win championships.</p></li>
					<input type="checkbox" class="chk"
						value="Excuses don't win championships.">
					<li class="sent"><img
						src="http://emilcarlsson.se/assets/mikeross.png" alt="" />
